...
import { BASE_URL } from '../../../config'; // Siguraduhin na tama ang path na ito sa config mo
...
const Checkout = (props) => {
  ...
  const confirmOrder = async () => {
    ...
    try {
      ...
      // I-reset ang navigation para hindi makabalik sa checkout
      props.navigation.reset({
        index: 0,
        routes: [{ name: 'Main' }, { name: 'MyOrders' }],
      });
